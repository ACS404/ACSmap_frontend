...
window.predictRisk = async function() {
  ...
  state.age = parseInt(document.getElementById('age').value) || null;
  state.pack_years = parseInt(document.getElementById('packYears').value) || 0;
  state.family_history = document.getElementById('familyHistory').checked;
  state.diabetes = document.getElementById('diabetes').checked;
  state.hepatitis = document.getElementById('hepatitis').checked;
